    ...
    options: [
      {
        ...
        points: { ecurie: 3 },
        raison: { fr: "sa baignoire en îlot avec une terrasse sous l'auvent", en: "its freestanding bathtub with a terrace under the eaves" },
      },
      {
        id: "cocon",
        libelle: { fr: "Un cocon à deux pas de la piscine", en: "A cocoon steps from the pool" },
        points: { lingerie: 3 },
        raison: { fr: "son ambiance 1900 à deux pas du couloir de nage", en: "its 1900s feel a few steps from the swimming lane" },
      },
      {
        id: "cuisine",
        libelle: { fr: "Une cuisine, pour être indépendants", en: "A kitchen, to be independent" },
        points: { grenier: 3 },
        raison: { fr: "ses 70 m² sous les toits avec cuisine équipée", en: "its 70 m² under the roof with a fitted kitchen" },
      },
    ],
  },
  {
